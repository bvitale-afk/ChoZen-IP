...
const COMMUNITY_HIGHLIGHTS = [
  { name: "Dan Buettner", role: "Blue Zones Founder", detail: "Keynote speaker and collaborator on longevity research" },
  { name: "Mapu", role: "Indigenous Leader", detail: "Ancestral wisdom and sacred ceremonies" },
  { name: "Himena", role: "Indigenous Leader", detail: "Plant medicine and traditional healing knowledge" },
];

const PILLARS = [
  { icon: "🌿", title: "Wellness", desc: "Holistic wellbeing through nature-based rhythms, thermal therapy, and regenerative healing modalities" },
  { icon: "🌾", title: "Agriculture", desc: "Regenerative onsite farming, food as medicine, and syntropic agroforestry systems" },
  { icon: "🏛", title: "Hospitality", desc: "Branded retreats, hotels, and short-term rentals rooted in conscious community" },
  { icon: "🌎", title: "Nature", desc: "Conservation, rewilding, and deep immersion in untamed land and wildlife corridors" },
  { icon: "🔥", title: "Ancestral Wisdom", desc: "Honoring indigenous knowledge, sacred practices, and the guidance of those who walked before us" },
  { icon: "🤝", title: "Community", desc: "A curated network of culture makers, changemakers, and regenerative builders worldwide" },
];

const BRAND_OFFERS = [
  { title: "Membership Community", desc: "An exclusive network of like-minded builders, wellness seekers, and culture makers. Tiered access to events, content, and location benefits.", icon: "◈" },
  { title: "Online Content", desc: "Digital platform featuring regenerative living education, practitioner access, wellness programming, and community forums.", icon: "◇" },
  { title: "Summits & Seminars", desc: "Curated gatherings worldwide — from intimate retreats to large-scale regenerative summits with global thought leaders.", icon: "△" },
  { title: "Special Events", desc: "Seasonal celebrations, equinox ceremonies, wellness gatherings, artist residencies, and community rituals.", icon: "○" },
];

const FLORIDA_FEATURES = [
  { label: "ChoZen Village", desc: "A regenerative neighborhood with branded residences, shared agricultural land, and communal wellness spaces" },
  { label: "Retreat Center", desc: "Immersive wellness retreats featuring breathwork, meditation, plant-based cuisine, and nature excursions" },
  { label: "Regenerative Farm", desc: "Onsite organic agriculture — syntropic farming, permaculture, and native biodiversity" },
  { label: "CCRL Nonprofit", desc: "ChoZen Center for Regenerative Living — education, scholarships, and conservation programs" },
  { label: "Blue Zones Connection", desc: "Aligned with Blue Zones longevity principles — community, movement, purpose, and whole food access" },
  { label: "Events & Programming", desc: "11+ years of community events — thousands served across wellness, culture, and regenerative education" },
];
...
const FUTURE_LOCATIONS = [
  {
    ...
    features: ["Branded Residences", "Agricultural Naturehood", "Artist Village", "Ancestral Wisdom Center"],
  },
  {
    city: "Florianópolis",
    country: "Brazil",
...
const INVESTMENT_LAYERS = [
  ...
  },
  {
    ...
    items: ["Lot / home acquisition", "JV partnership per site", "Florida (active)", "Colombia (in development)", "Future pipeline locations"],
    color: "#3A6B7E",
  },
];

const PILLARS_BRAND = [
  { icon: "🌱", title: "Regenerative Onsite Agriculture", yes: "Regenerative onsite agriculture model rooted in native biodiversity and organic production. Food as medicine. Land health through data-driven sustainability.", no: "No greenwashing. No chemical fertilizers, synthetic pesticides, fungicides, or herbicides.", tags: ["Soil Health", "Agroforestry", "Permaculture", "Syntropic Farming"] },
  { icon: "✦", title: "Holistic Wellbeing", yes: "Performance, longevity, and regenerative healing through advanced wellness technology and practitioner access.", no: "No superficial wellness tactics or unqualified practitioners.", tags: ["Nature-Based Rhythms", "Thermal Therapy", "Longevity"] },
  { icon: "🌿", title: "Every Day Whole Food Access", yes: "Nutritious, whole meals from locally sourced, regenerative ingredients.", no: "No global corporate food distributors. No factory-farmed proteins.", tags: ["Curated Grocer", "Local Retailers", "Low Waste", "Café"] },
  { icon: "🌿", title: "Access to Untamed Land", yes: "Minimum five acres of natural environment. Direct access to open, undeveloped landscapes.", no: "Not situated in dense urban environments without meaningful nature access.", tags: ["50% Conservation", "Microforests", "Open Space"] },
  { icon: "🔥", title: "Primal Interactions", yes: "Environments that reawaken the body's innate connection to nature through movement and sensory immersion.", no: "No staged activities, artificial props, or curated photo-ops.", tags: ["ChoZen Flow", "Rewilding", "Off-Grid Zone", "Presence"] },
  { icon: "🤝", title: "Conscious Community", yes: "Seasonal events, wellness gatherings, group hikes, meditation, breathwork, yoga.", no: "No transactional, impersonal programming lacking seasonal alignment.", tags: ["Tech-Free Spaces", "Memberships", "Shared Rituals"] },
  { icon: "🏗", title: "Regenerative Design", yes: "Regenerative Placemaking standards. High-performance building systems, renewable energy, sustainable materials.", no: "No low-performance systems, harmful materials, or depleting practices.", tags: ["Biophilia", "Local Materials", "Net Zero", "Water Quality"] },
  { icon: "♻️", title: "Circular Operations", yes: "Smart energy, renewable power, toxin-free cleaning, local food. No plastics.", no: "No wasteful energy, chemical-laden products, or single-use plastics.", tags: ["No Plastics", "Solar", "Compost", "Aspiring Net Zero"] },
  { icon: "❤️", title: "Serving Local Community", yes: "Partnerships with local non-profits. Marine and land conservation. ESG-focused scholarships.", no: "Not an isolated or extractive model that overlooks local impact.", tags: ["Makers Spaces", "Artisan Markets", "Artist Residencies"] },
];
...
function SymbolSVG({ id, size = 64 }) {
  ...
  if (id === "water") return (<svg {...common}><circle cx={c} cy={c} r={r} stroke={stroke} strokeWidth={sw} /><path d={`M ${c - r * 0.85} ${c} Q ${c - r * 0.42} ${c - r * 0.35} ${c} ${c} Q ${c + r * 0.42} ${c + r * 0.35} ${c + r * 0.85} ${c}`} stroke={stroke} strokeWidth={sw} /></svg>);
  if (id === "unity") return (<svg {...common}><circle cx={c} cy={c} r={r} stroke={stroke} strokeWidth={sw} /></svg>);
  if (id === "divine") return (<svg {...common}><circle cx={c} cy={c} r={r} stroke={stroke} strokeWidth={sw} /><line x1={c - r * 0.71} y1={c - r * 0.71} x2={c + r * 0.71} y2={c + r * 0.71} stroke={stroke} strokeWidth={sw} /><line x1={c + r * 0.71} y1={c - r * 0.71} x2={c - r * 0.71} y2={c + r * 0.71} stroke={stroke} strokeWidth={sw} /><circle cx={c} cy={c} r={r * 0.35} stroke={stroke} strokeWidth={sw * 0.8} /></svg>);
  if (id === "balance") return (<svg {...common}><circle cx={c} cy={c} r={r} stroke={stroke} strokeWidth={sw} /><line x1={c - r * 0.71} y1={c - r * 0.71} x2={c + r * 0.71} y2={c + r * 0.71} stroke={stroke} strokeWidth={sw} /><line x1={c + r * 0.71} y1={c - r * 0.71} x2={c - r * 0.71} y2={c + r * 0.71} stroke={stroke} strokeWidth={sw} /></svg>);
  if (id === "activism") return (<svg {...common}><polygon points={`${c - r * 0.6},${c - r * 0.65} ${c + r * 0.6},${c - r * 0.65} ${c},${c}`} stroke={stroke} strokeWidth={sw} fill="none" /><polygon points={`${c - r * 0.6},${c + r * 0.65} ${c + r * 0.6},${c + r * 0.65} ${c},${c}`} stroke={stroke} strokeWidth={sw} fill="none" /></svg>);
  return null;
}
    ...
    <nav className={`nav ${scrolled ? "scrolled" : ""}`}>
      <div className="navInner">
        ...
        <div className={`navLinks ${open ? "open" : ""}`}>
          {links.map((l) => (
            <a key={l.href} href={l.href} className={active === l.href.slice(1) ? "active" : ""} onClick={() => setOpen(false)}>{l.label}</a>
          ))}
        </div>
...
function FadeIn({ children, delay = 0, className = "" }) {
  ...
  return (
    <div ref={ref} className={className} style={{ opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(32px)", transition: `opacity 0.7s ${delay}s, transform 0.7s ${delay}s` }}>
      {children}
    </div>
  );
}
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, background: "rgba(30,26,20,0.85)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }} onClick={onClose}>
      <div style={{ background: "var(--warm-white)", borderRadius: 16, maxWidth: 900, width: "100%", maxHeight: "90vh", overflow: "hidden", display: "flex", flexDirection: "column" }} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "32px 40px" }}>
          ...
          {p.symbols && <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: 16, marginTop: 20 }}>{p.symbols.map((s, i) => (<div key={i} style={{ textAlign: "center", padding: "20px 12px", background: "var(--cream)", borderRadius: 8 }}><div style={{ marginBottom: 12, display: "flex", justifyContent: "center" }}><SymbolSVG id={s.svgId} size={56} /></div><div style={{ fontWeight: 700, fontSize: "0.78rem", color: "var(--earth)", marginBottom: 6 }}>{s.name}</div><div style={{ fontSize: "0.68rem", color: "var(--text-light)", lineHeight: 1.5, whiteSpace: "pre-line" }}>{s.meaning}</div></div>))}</div>}
          {p.voice && (
          ...
          {!p.text && !p.items && !p.lines && !p.venn && !p.symbols && !p.voice && page !== 0 && (<div style={{ marginTop: 16 }}><img src={p.img} alt={p.title} style={{ maxWidth: "100%", borderRadius: 8 }} /></div>)}
...
function WaitlistForm() {
  ...
  const handleSubmit = (e) => { e && e.preventDefault && e.preventDefault(); setSubmitted(true); };
  ...
  return (
    <div className="waitlistForm">
      <div className="waitlistFields">
        ...
        <div className="waitlistField">
          ...
          <select value={form.interest} onChange={(e) => setForm({ ...form, interest: e.target.value })}>
            ...
            <option value="florida">Florida — Lot Reservation</option>
            <option value="colombia">Colombia — Early Access</option>
      ...
      <button className="ctaBtn" onClick={handleSubmit}>Join the Waitlist →</button>
    ...
    <>
      ...
      <section className="hero" id="hero">
        <div className="heroContent">
          ...
          <p className="heroTagline">
            A regenerative living brand built on 11+ years of community,<br />
      ...
      <section className="section" id="story">
        <SectionHeader
          ...
          desc="Born in Florida over 11 years ago, ChoZen evolved from a community gathering into a regenerative wellness, hospitality, and nature brand — building bridges, not walls."
        />
        <FadeIn>
          <div className="storyGrid">
            <div className="storyCard storyCardMain">
              <div className="storyCardInner">
                ...
                <p>
                  What started as intimate gatherings around fire, food, and shared intention grew into something
                  much larger — a movement. Over a decade of curated events, wellness programming, and
                  regenerative placemaking built a community of thousands: culture makers, healers, builders,
                  and visionaries united by a common ethos.
                </p>
                <p style={{ marginTop: 16 }}>
                  ChoZen is now a licensable brand platform — packaging regenerative design, ancestral wisdom,
                  and conscious hospitality into a framework that developers and investors can bring to life
            ...
            <div className="storyCard storyCardMission">
              ...
              <p>Building bridges, not walls. Creating spaces where nature is medicine, food is medicine, and community is medicine.</p>
            </div>
            <div className="storyCard storyCardBook">
              <div className="storyCardLabel">Framework</div>
              <h3>Generation Regeneration</h3>
              <p>The intellectual backbone — a book and framework outlining the principles of regenerative living, placemaking, and conscious development.</p>
            </div>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.2}>
          <div className="communitySection">
            <h3 className="commTitle">Notable Community &amp; Collaborators</h3>
            <div className="commGrid">
              ...
              <div className="commCard commCardMore">
                ...
                <div className="commDetail">Thought leaders, indigenous elders, wellness practitioners, chefs, artists, and builders from around the world.</div>
              </div>
            </div>
          </div>
        </FadeIn>
      ...
      <section className="sectionAlt" id="brand">
        <div className="sectionInner">
          <SectionHeader
            ...
            desc="ChoZen is more than a place — it's a wellness, hospitality, and nature brand with a built-in community of culture makers and changemakers."
          />
          <FadeIn>
          ...
          <FadeIn delay={0.15}>
            <div style={{ marginTop: 80 }}>
              <h3 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.4rem, 2.5vw, 2rem)", color: "var(--earth)", textAlign: "center", marginBottom: 12 }}>We Are vs. We Are Not</h3>
              <div className="divider" />
              <p style={{ fontSize: "0.88rem", color: "var(--text-light)", textAlign: "center", maxWidth: 560, margin: "0 auto 40px" }}>
                A clear declaration of what ChoZen stands for — and what it rejects.
              </p>
      ...
      <section className="section" id="offerings">
        <SectionHeader
          ...
          desc="An exclusive ecosystem of membership, content, events, and community — designed for culture makers who build, not just consume."
        />
        <FadeIn>
        ...
        <FadeIn delay={0.15}>
          <div className="offerCallout">
            <div className="offerCalloutInner">
              ...
              <p>ChoZen members don&apos;t just attend — they build. A curated network of developers, wellness practitioners, chefs, artists, and thought leaders creating the future of regenerative living together.</p>
            </div>
          </div>
        </FadeIn>
      </section>
      ...
      <section className="section" id="locations">
        <SectionHeader
          ...
          desc="ChoZen is expanding — replicating the regenerative model in markets aligned with the brand's ethos of nature, community, and conscious living."
        />
        <FadeIn>
          <div className="locationsGrid">
            {FUTURE_LOCATIONS.map((loc, i) => (
              <div key={i} className={`locationCard ${i === 0 ? "locationCardFeatured" : ""}`}>
        ...
        <div className="sectionInner">
          <div className="sectionHeader">
            ...
            <p className="sectionDesc" style={{ color: "var(--sand)" }}>
              Two distinct layers of participation — invest at the brand level, the site level, or both.
            </p>
          </div>
          <FadeIn>
      ...
      <section className="section" id="waitlist">
        <SectionHeader
          ...
          desc="Whether you're a future resident, community member, or investor — your journey starts here."
        />
        <FadeIn>
          <WaitlistForm />
        </FadeIn>
        <FadeIn delay={0.15}>
          <div className="ctaCards">
            ...
            <div className="ctaCard">
              ...
              <p>Inquire about lot and home reservations in current or future ChoZen locations.</p>
            </div>
            <div className="ctaCard">
              <h4>Investment Inquiry</h4>
              <p>Deeper investment access requires NDA execution and qualified investor vetting.</p>
            </div>
          </div>
        </FadeIn>
      </section>
